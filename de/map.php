...
<body>
    ...
    <div class="container mt-3 text-center">
        <div class="btn-group-map">
            <button class="btn btn-outline-primary" onclick="history.back()">Zurück</button>
            <button class="btn btn-outline-primary" onclick="history.forward()">Weiter</button>
        </div>
    ...
    <script>
        ...
        <?php else: ?>
            setTimeout(function() {
                ...
                mapDiv.innerHTML = '<span style="color: red; font-weight: bold;">Bitte geben Sie eine URL zu einer validen GeoJSON-Datei an!</span>';
            }, 1000);
        <?php endif; ?>
